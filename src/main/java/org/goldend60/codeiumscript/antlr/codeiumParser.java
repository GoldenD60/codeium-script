...
public class codeiumParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, T__26=27, WS=28, COMMENT=29, LINE_COMMENT=30, Namespace=31, 
		Int=32, String=33, Load=34, Return=35, Selector=36, If=37, Else=38, Kill=39, 
		Tell=40, Ident=41, SelectorLit=42, IntLit=43, StrLit=44;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'/'", "'%'", "'+'", "'-'", "'>='", "'<='", "'>'", "'<'", "'=='", "'!='", 
			"'='", "';'", "'+='", "'-='", "'*='", "'/='", "'%='", "'><'", null, null, 
			null, "'namespace'", "'int'", "'string'", "'load'", "'return'", "'selector'", 
			"'if'", "'else'", "'kill'", "'tell'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, "WS", "COMMENT", "LINE_COMMENT", "Namespace", 
			"Int", "String", "Load", "Return", "Selector", "If", "Else", "Kill", 
			"Tell", "Ident", "SelectorLit", "IntLit", "StrLit"
		};
	}
	...
	public final NamespaceContext namespace() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 81604378624L) != 0)) {
				{
				{
				setState(35);
				nsblock();
	...
	public final ScopeContext scope() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8327941586946L) != 0)) {
				{
				{
				setState(51);
				instruction();
	...
	public final FuncCallContext funcCall() throws RecognitionException {
		...
		try {
			...
			case SelectorLit:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32985348833296L) != 0)) {
					{
					setState(100);
					args();
					}
